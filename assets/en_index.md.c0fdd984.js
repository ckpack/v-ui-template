import{_ as e,y as n,x as a,W as s}from"./plugin-vue_export-helper.54ce3857.js";const f='{"title":"v-ui-template","description":"","frontmatter":{},"headers":[{"level":2,"title":"Features","slug":"features"},{"level":2,"title":"Script commands","slug":"script-commands"},{"level":2,"title":"download","slug":"download"},{"level":2,"title":"Global replacement variables","slug":"global-replacement-variables"},{"level":2,"title":"Modify component prefix","slug":"modify-component-prefix"},{"level":2,"title":"Start creating components","slug":"start-creating-components"}],"relativePath":"en/index.md","lastUpdated":1649669651579}',t={},o=s(`<h1 id="v-ui-template" tabindex="-1">v-ui-template <a class="header-anchor" href="#v-ui-template" aria-hidden="true">#</a></h1><p>You can use this project to quickly create a component library based on vue 3.0. This is a super fast and super simple way to generate vue component library!</p><h2 id="features" tabindex="-1">Features <a class="header-anchor" href="#features" aria-hidden="true">#</a></h2><ul><li>Quickly add new components via commands</li><li>All components support on-demand loading by default</li><li>Customizable component prefix to avoid component name and style conflicts</li><li>Support component library document generation</li></ul><h2 id="script-commands" tabindex="-1">Script commands <a class="header-anchor" href="#script-commands" aria-hidden="true">#</a></h2><p>For detailed commands, refer to the <code>scripts</code> part of <code>package.json</code></p><div class="language-bash"><pre><code><span class="token comment"># Installation dependencies</span>
...
</code></pre></div>`,24),c=[o];function p(l,d,i,r,m,u){return a(),n("div",null,c)}var k=e(t,[["render",p]]);export{f as __pageData,k as default};
